function loadFurniture() {
    ...
    getModel("shelf.obj", 0, 0, 0, "SofaCollection.mtl", 1.3, 10, 15, -11); // Bigmax_White_OBJ.obj
    getModel("Bigmax_White_OBJ.obj", 0, 0, 0, "Bigmax_White_OBJ.mtl", 7, 15, 5, -28);
    getModel("D_Plant.obj", 4.7, 0, 0, "D_Plant.mtl", 10, 60, 10, -28);

    //KITCHEN
    getModel("modern_table_and_chairs_obj.obj", 0, 0, 0, "modern_table_and_chairs_obj.mtl", 12, 45, 5, 50); // Kitchen_3_Wardrobe.obj
    ...
    //getModel( "Cocktail_Table.obj" , 0, 0, 0, "SofaCollection.mtl", 18, -20, 5.5, 25); // sofa table without texture
    getModel( "Coffeet2.obj" , 4.7, 0, 4.7, "Coffeet2.mtl", 24, -10, 5, 82);
    getModel( "sofa.obj" , 0, 0, 0, "sofa.mtl", 24, -5, 8.5, 60);
    getModel("mus001.obj", 4.7, 0, 0, "mus001.mtl", 6, -30, 5, 68); //piano
    getModel("painting.obj", 0, 0, 0, "painting.mtl", 25, -9, 9, 11.4); //Painting

    //CORRIDOR
    getModel("Coat-Tree.obj", 4.7, 0, 0, "Coat-Tree.mtl", 26, -40, 7, -5); // D_Plant.obj
